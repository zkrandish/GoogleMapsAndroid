...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void navigateToActivitySecond() {
        ...
        int checkedRadioButton=rgSport.getCheckedRadioButtonId();
        int whichRbButton=-100;
        if(checkedRadioButton==R.id.rbSoccer){
            whichRbButton=0;
        } else if (checkedRadioButton==R.id.rbHandball) {
            whichRbButton=1;
        }else if (checkedRadioButton==R.id.rbHockey){
            whichRbButton=2;
        }
